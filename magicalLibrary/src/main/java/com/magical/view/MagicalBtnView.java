...
public class MagicalBtnView extends TextView {
    ...
    public MagicalBtnView(Context context) {
        super(context);
        init(null, 0);
    }


    public MagicalBtnView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }


    public MagicalBtnView(Context context, AttributeSet attrs, int defStyle) {
