 ...
 */
public class MagicalLinearlayout extends LinearLayout {

    private static final String TAG = MagicalLinearlayout.class.getSimpleName();

    private static final int DEFAULT_BG_COLOR = R.color.default_layout_bg_color;
    private static final int DEFAULT_FRAME_COLOR = R.color.default_layout_frame_color;
    ...
    public MagicalLinearlayout(Context context) {
        super(context);
        init(null, 0);
    }


    public MagicalLinearlayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }


    public MagicalLinearlayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        if (null != a) {
            ...
            bgColor = a
                    .getColor(R.styleable.MagicalTextView_bgColor, getResources().getColor(DEFAULT_BG_COLOR));
            frameColor = a
                    .getColor(R.styleable.MagicalTextView_frameColor, getResources().getColor(DEFAULT_FRAME_COLOR));
            a.recycle();
        }
